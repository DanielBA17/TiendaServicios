...
namespace TiendaServicios.Api.Libro.Tests
{
    public class LibrosServiceTest
    {
        ...
        public async void GetLibros()
        {
            ...
            // 3. Instancia a la clase manejador y pasarle de parametros los mocks
